...
<h1 id="XdpFM">后端部署（京东轻量云主机提供MySQL和Redis服务+宝塔+Render后端部署）</h1>
京东云主机可以选择预安装宝塔
...
在dockerdesktop查看镜像ID

```abap
docker tag f650ec825382 dockerusername/projectName:tags
example：
docker tag f650ec82538 crazy/findcompanions:v1.0
```
